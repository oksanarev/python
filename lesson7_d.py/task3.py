...
class Cell:
    ...
    def __sub__(self, other):
        return Cell((self._count - other._count) if self._count - other._count > 0 else
                    print('Опперация вычитания - невозможна!'))
    ...
    def make_order(self, cells_in_row: int) -> str:
        rows, tail = self._count // cells_in_row, self._count % cells_in_row
        return str('\\n'.join(['*' * cells_in_row] * rows + ['*' * tail]))
...
print((cells1 * cells2).make_order(7))
